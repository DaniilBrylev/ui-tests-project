...
Проект создан в учебных целях, однако по структуре и подходам приближен к реальным задачам автоматизированного тестирования и может быть использован как часть портфолио.
...
2. Переход в категорию.
3. Открытие товара и проверка его названия.
4. Отправка формы *Contact* с проверкой появления alert-сообщения.
...
1. Поиск статьи и проверка первого результата.
2. Открытие статьи и проверка заголовка.
3. Прокрутка статьи до блока *References* и проверка его отображения.
